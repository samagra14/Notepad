...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initObjects() {
        databaseHelper = new NotesDbHelper(this);
    ...
    private void verifyFromSQLite() {
        if (!inputValidation.isInputEditTextFilled(textInputEditTextUserName, textInputLayoutEmail, getString(R.string.error_message_email))) {
            return;
        }
